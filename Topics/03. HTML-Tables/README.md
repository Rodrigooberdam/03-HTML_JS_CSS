...
<!-- # Simple HTML Tables -->
## [Demo](demos/1.%20Simple-tables.html)
...
## [Demo](demos/2.%20Data-and-header-cells.html)
...
<!-- attr: { class:'slide-section demo', showInPresentation:true, hasScriptWrapper:true, style:'font-size: 42px' } -->
<!-- # Complete HTML Tables -->
## [Demo](demos/3.%20Complete-tables.html)
...
<!-- attr: { class:'slide-section demo', showInPresentation:true, hasScriptWrapper:true, style:'font-size: 42px' } -->
<!-- # Nested Tables -->
## [Demo](demos/4.%20Nested-tables.html)
...
## [Demo](demos/5.%20Table-cells-spacing-padding.html)
...
## [Demo](demos/6.%20Table-colspan-rowspan.html)
